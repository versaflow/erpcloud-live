...
class RestApiController extends BaseController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->middleware(function ($request, $next) {
            ...
            if (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\RestApiController@register') {
                // signup returns auth token

            } elseif (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\RestApiController@getAccount') {
            ...
            } elseif (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\RestApiController@postLogin') {
                // signup returns auth token

            } elseif (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\RestApiController@endpoints') {
