...
class RestApiController extends BaseController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->middleware(function ($request, $next) {
            ...
            if (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\Api\\RestApiController@register') {
                // signup returns auth token

            } elseif (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\Api\\RestApiController@getAccount') {
            ...
            } elseif (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\Api\\RestApiController@postLogin') {
                // signup returns auth token

            } elseif (\Route::getCurrentRoute()->getActionName() == 'App\\Http\\Controllers\\Api\\RestApiController@endpoints') {
    ...
    public function postLogin()
    {
        ...
        if ($validator->passes()) {
            ...
            if (! \Auth::attempt(['username' => $this->request->input('username'), 'password' => $this->request->input('password')], true)) {
                \Auth::logout();
            ...
            if (empty($account) || $account->status == 'Deleted') {
                \Auth::logout();
