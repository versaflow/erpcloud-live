...
class RestApiController extends BaseController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->middleware(function ($request, $next) {
            ...
            if('App\\Http\\Controllers\\Api\\RestApiController@register' == \Route::getCurrentRoute()->getActionName()) {
                // signup returns auth token
                  
            }else if('App\\Http\\Controllers\\Api\\RestApiController@getAccount' == \Route::getCurrentRoute()->getActionName()) {
            ...
            }else if('App\\Http\\Controllers\\Api\\RestApiController@postLogin' == \Route::getCurrentRoute()->getActionName()) {
                // signup returns auth token
                  
            }else if ('App\\Http\\Controllers\\Api\\RestApiController@endpoints' == \Route::getCurrentRoute()->getActionName()) {
