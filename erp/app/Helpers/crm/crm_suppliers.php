    ...
    foreach ($suppliers as $supplier) {
        ...
        foreach ($months as $month) {
            ...
            */
            ...
            $docids = \DB::table('crm_documents')->where('doctype', 'Tax Invoice')->where('billing_type', 'Monthly')->where('reference', $reference)->where('document_currency', 'ZAR')->pluck('id')->toArray();
            $usd_docids = \DB::table('crm_documents')->where('doctype', 'Tax Invoice')->where('billing_type', 'Monthly')->where('reference', $reference)->where('document_currency', 'USD')->pluck('id')->toArray();
