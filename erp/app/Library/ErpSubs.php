...
class ErpSubs
{
    ...
    public function processMigration($id)
    {
        ...
        try {
            ...
            if ('hosting' == $name || 'sitebuilder' == $name) {
            ...
            if ('pbx_extension' == $name || 'sip_trunk' == $name || 'unlimited_channel' == $name) {
    ...
    public function updateSubscriptionsTotal($account_id)
    {
        ...
        foreach ($account_ids as $id) {
            ...
            if (1 == $account->vat_enabled && $total > 0) {
                $tax = $total * 0.15;
                $total = $total + $tax;
            }
        ...
        if ('reseller' == $account->type) {
            if (1 == $admin->vat_enabled && $partner_total > 0) {
