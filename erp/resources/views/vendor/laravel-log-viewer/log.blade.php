@php
$menu_name = 'Log Viewer';
@endphp

@extends((( request()->ajax()) ? '__syncfusion.layouts.ajax' : '__syncfusion.layouts.app' ))

@if(!request()->ajax())
  @include('__syncfusion.layouts.header')
  @include('__syncfusion.components.dialog')
@endif
