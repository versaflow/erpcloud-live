...
<head>
    ...
    <link href="https://kendo.cdn.telerik.com/2021.2.616/styles/kendo.default.mobile.min.css" rel="stylesheet" />
            ...
            $("#drawer").kendoDrawer({
                ...
                itemClick: function (e) {
                    if (!e.item.hasClass("k-drawer-separator")) {
                        var menu_id = e.item.find(".k-item-text").attr("data-id");
                        var url = e.item.find(".k-item-text").attr("data-href");
                        var new_tab = e.item.find(".k-item-text").attr("data-tab");
                        var data_target = e.item.find(".k-item-text").attr("data-target");
                        ...
                        if (expandIcon.length) {
                            var items =  e.item.closest('ul').find("[data-attr-menu-parent='" + menu_id + "']");
                            e.item.closest('ul').find("[data-attr-menu-parent='" + menu_id + "']").removeClass("hidden");
                            expandIcon.removeClass("k-i-arrow-chevron-right").addClass("k-i-arrow-chevron-down");
                        }

                        if (collapseIcon.length) {
                            e.item.closest('ul').find("[data-attr-menu-parent='" + menu_id + "']").addClass("hidden");
