...
@section('content')
    <form action="/provision_service_post" id="provision_form" class="stepbox mx-auto">
    <input type="hidden" name="provision_plan_id"  value="{{$provision_plan_id}}">
...
if($("#prefix").length > 0 ){
	window['phone_number'] = new ej.dropdowns.DropDownList({
		...
		ignoreAccent: true,
		allowFiltering: true,
		fields: {text: 'display_number', value: 'number'},
