		...
		<div class="col">
			<div class="relative w-full text-left">
				<label class="flex text-sm not-italic items-center font-medium text-gray-800 whitespace-nowrap justify-between mb-1 mt-2">
					...
					<div class="flex flex-col">
						<div class="relative rounded-md shadow-sm font-base">
							<input type="text" id="company" name="company" class="font-base block w-full sm:text-sm border-gray-200 rounded-md text-black focus:ring-primary-400 focus:border-primary-400">
						</div>
					</div>
			</div>
		</div>
