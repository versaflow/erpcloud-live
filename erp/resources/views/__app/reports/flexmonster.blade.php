...
@else
@include('__app.layouts.header_title')
@endif
    ...
    //https://www.flexmonster.com/question/in-mobile-view-format-options-and-fields-menu-are-not-getting-displayed/
		...
		function customizeToolbar(toolbar) { 
		    ...
		    var queryEditorHandler = function() { 
		         // add new functionality 
		         //console.log('/report_query/{{ $id }}?report_connection={{$connection}}');
        ...
        function loadConfig(){
        	...
        	if(json_config && json_config.report){
        		pivot.load('/report_config_load?report_connection={{$connection}}&id={{$id}}');
        	}else{
