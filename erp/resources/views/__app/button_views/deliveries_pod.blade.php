{!! Form::open(array("url"=> "deliveries_pod/".$id, "class"=>"form-horizontal","files" => true , "parsley-validate"=>"","novalidate"=>" ","id"=> "ImportFormAjax")) !!}		
<div class="row" >
    <label for="Import" class=" control-label col-md-3 text-left"> POD File </label>
    <div class="col-md-9">
