...
@endsection
@section('css')
    <link rel="stylesheet" href="{{ public_path().('/assets/velzon/libs/gridjs/gridjs.min.css') }}">
@endsection
@section('content')
...
@endsection
@section('script')
    <script src="{{ public_path().('/assets/velzon/libs/prismjs/prismjs.min.js') }}"></script>
    <script src="{{ public_path().('/assets/velzon/libs/gridjs/gridjs.min.js') }}"></script>
    <script src="{{ public_path().('/assets/velzon/js/pages/gridjs.init.js') }}"></script>

    <script src="{{ public_path().('//assets/velzon/js/app.min.js') }}"></script>
@endsection
