                            ...
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                <div>
                                    <a href="index" class="d-inline-block auth-logo">
                                        <img src="{{ public_path().('/assets/velzon/images/logo-light.png') }}" alt="" height="20">
                                    </a>
                                </div>
...
@endsection
@section('script')
    <script src="{{ public_path().('/assets/velzon/libs/particles.js/particles.js.min.js') }}"></script>
    <script src="{{ public_path().('/assets/velzon/js/pages/particles.app.js') }}"></script>
    <script src="{{ public_path().('/assets/velzon/js/pages/two-step-verification.init.js') }}"></script>
@endsection
