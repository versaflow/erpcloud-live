...
@section('content')
                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="index" class="d-block auth-logo">
                                                                <img src="{{ public_path().('/assets/velzon/images/logo-dark.png')}}" alt="" height="22" class="auth-logo-dark me-start">
                                                                <img src="{{ public_path().('/assets/velzon/images/logo-light.png')}}" alt="" height="22" class="auth-logo-light me-start">
                                                            </a>
                                                        </div>
                    ...
                    <div class="col-xxl-8 col-lg-8 col-md-6">
                        <div class="auth-bg bg-white py-md-5 p-4 d-flex">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-xl-8">
                                    <div class="mt-4">
                                        <img src="{{public_path().('/./assets/velzon/images/login-img.png')}}" class="img-fluid" alt="">
                                    </div>
        ...
        @endsection
@section('script')
    <script src="{{ public_path().('/assets/velzon/js/pages/eva-icon.init.js') }}"></script>
@endsection
