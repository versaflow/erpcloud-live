...
<div class="card h-100 " id="content_sidebar">
    ...
    <div class="card-header p-0">
        <ul class="nav nav-pills nav-fill pt-1 p-1" role="tablist" id="right_sidebar_ul">
            ...
            @if($first_tab == 'services')
            
                
                @if($show_subscriptions_tab)  
                    <li class="nav-item" id="content_sidebar_services_li" name="Support">
                    <a id="content_sidebar_first_tab" class="nav-link mb-0 px-0 py-0 " data-bs-toggle="tab" href="#content_sidebar_telecloud{{$grid_id}}" role="tab"  title="Support">
                    <i class="fas fa-cloud  text-sm me-1"></i><br>Support
                    </a>
                    </li>
                @endif
                ...
                @if(is_superadmin())
                <li class="nav-item" id="content_sidebar_support_li" name="NOC">
                <a class="nav-link mb-0 px-0 py-0 " data-bs-toggle="tab" href="#content_sidebar_support{{$grid_id}}" role="tab"  title="NOC">
                <i class="fas fa-server  text-sm me-1"></i><br>NOC
                </a>
                </li>
                @endif
                ...
                @if(session('role_level') == 'Admin')
                <li class="nav-item" id="content_sidebar_grid_li" name="Grid">
                <a id="content_sidebar_first_tab" class="nav-link mb-0 px-0 py-0 " data-bs-toggle="tab" href="#content_sidebar_grid{{$grid_id}}" role="tab"  title="Grid">
                <i class="fas fa-desktop  text-sm me-1"></i><br>Grid
                </a>
                </li>
                @endif
            @elseif($first_tab == 'system')
