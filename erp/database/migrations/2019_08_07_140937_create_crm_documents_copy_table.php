...
class CreateCrmDocumentsCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crm_documents_copy', function (Blueprint $table) {
            ...
            $table->integer('reseller_user')->nullable();
    ...
    {
        Schema::drop('crm_documents_copy');
    }
}
