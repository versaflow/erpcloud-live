...
class CreateCrmAccountPartnerSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crm_account_partner_settings', function (Blueprint $table) {
    ...
    {
        Schema::drop('crm_account_partner_settings');
    }
}
