...
class CreateAccSubscriptionsCopyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_services_copy', function (Blueprint $table) {
            ...
            $table->float('last_usage', 10, 0)->default(0);
            $table->float('current_usage', 10, 0)->default(0);
