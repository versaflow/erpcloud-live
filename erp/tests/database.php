    ...
    */
    'connections' => [
        ...
        'eldooffice' => [
            ...
            'password' => env('DB_PASSWORD', 'N6rerXL9KUq1kuCf3Sm7'),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
            'strict' => false,
        ...
        'vehicledb' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'accudata'),
            'username' => env('DB_USERNAME', 'accudata'),
            'password' => env('DB_PASSWORD', 'L2YcY0HTM45bFvPXn490'),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
            'strict' => false,
