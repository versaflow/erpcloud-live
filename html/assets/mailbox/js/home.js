...
window.home = function () {
    ...
    var ajaxHTML = new ej.base.Ajax('assets/mailbox/src/home/newmail.html', 'GET', true);
    ...
    ajaxHTML = new ej.base.Ajax('assets/mailbox/src/home/readingpane.html', 'GET', true);
    ajaxHTML.send().then(function (value) {
...
function renderMainSection() {
   /*
    var folderData = new ej.data.DataManager({
        url: 'mailbox_data?get_folders=1',
        adaptor: new ej.data.UrlAdaptor(),
        crossDomain: true,
    });
    */
    treeObj = new ej.navigations.TreeView({
        fields: { dataSource: folderData, id: 'ID', text: 'Name', parentID: 'PID', hasChildren: 'HasChild', expanded: 'Expanded' },
    ...
    /*
    messageDataSource = new ej.data.DataManager({
        url: 'mailbox_data?get_folders=1',
        adaptor: new ej.data.UrlAdaptor(),
        crossDomain: true,
    });
    */
    ...
    toolbarHeader = new ej.navigations.Toolbar({
        items: [
            {
...
function renderReplyAllList() {
    var themeList = [
        { text: 'Reply', iconCss: "e-splitbuttons-icons e-reply" },
        { text: 'Reply All', iconCss: "e-splitbuttons-icons e-replyAll" },
        { text: 'Forward', iconCss: "e-splitbuttons-icons e-forward" }
    ];
...
function renderToolbarMobile() {
    ...
    toolbarMobile = new ej.navigations.Toolbar({
        items: [
...
function openPopup() {
    ...
    var newMessageData = cloneObject(messageDataSource[1]);
    var key = 'text';
